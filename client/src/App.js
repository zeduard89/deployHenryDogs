 ...
 const renderFormButton = (event) =>{
  ...
  return (
    ...
    <div className="App">
      ...
      renderForm.card?(<Route path='/' element={<Cards renderStatus={renderForm.card} renderFormButton={renderFormButton}/> }/>)
                 :(<Route path='/' element={<CardsTemps renderStatus={renderForm.card} renderFormButton={renderFormButton}/> }/>)
